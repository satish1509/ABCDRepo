...
public class Implicit {
	...
	public static void main(String[] args) {
		...
		System.setProperty("webdriver.chrome.driver","C:\\Users\\91939\\eclipse-workspace\\Automation_project\\Drivers\\chromedriver.exe");
	      ...
	      wait.until(ExpectedConditions.invisibilityOf(driver.findElement(By.id("ui-id-2"))));
	      System.out.println(driver.findElement(By.id("ui-id-2")).getText());
	      driver.findElement(By.id("ui-id-3")).click();
	      wait.until(ExpectedConditions.invisibilityOf(driver.findElement(By.id("ui-id-4"))));
	      System.out.println(driver.findElement(By.id("ui-id-4")).getText());
	      driver.findElement(By.id("ui-id-5")).click();
	      wait.until(ExpectedConditions.invisibilityOf(driver.findElement(By.id("ui-id-6"))));
	      System.out.println(driver.findElement(By.id("ui-id-6")).getText());
	      driver.findElement(By.id("ui-id-7")).click();
	      wait.until(ExpectedConditions.invisibilityOf(driver.findElement(By.id("ui-id-8"))));
